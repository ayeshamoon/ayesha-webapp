...
with tab1:  #Inside the first tab.
    ...
    with col2:
        st.write("Hello, I am Ayesha Shariff, a computer teacher and content developer :computer: . My parents find it challenging to manage and track their expenses. So, I created a website  to help them in tracking and managing their expenses. You can use this website to manage and track your expenses as well. I hope you all like it.")
